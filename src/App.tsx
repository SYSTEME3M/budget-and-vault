...
import ProduitsDigitauxPage from "@/pages/boutique/ProduitsDigitauxPage"; // Ajouté ici
    ...
    <BrowserRouter>
      <TooltipProvider>
        ...
        <Routes>
          ...
          <Route path="/boutique/produits-digitaux" element={<AuthGuard><ProduitsDigitauxPage /></AuthGuard>} /> {/* Ajouté ici */}
